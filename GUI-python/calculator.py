...
metext=Entry(me,font=("Courier New",12,'bold'),textvar=textin,width=25,bd=5,bg='power blue')
metext.pack()
...
butp1=Button(me,padx=14,pady=14,bd=4,bg='light blue',text="+",command=lambda:clickbut("+"),font=("Courier New",16,'bold'))
butp1.place(x=205,y=100)

butsub=Button(me,padx=14,pady=14,bd=4,bg='light blue',text="-",command=lambda:clickbut("-"),font=("Courier New",16,'bold'))
butsub.place(x=205,y=170)

butml=Button(me,padx=14,pady=14,bd=4,bg='light blue',text="*",command=lambda:clickbut("*"),font=("Courier New",16,'bold'))
butml.place(x=205,y=240)

butdiv=Button(me,padx=14,pady=14,bd=4,bg='light blue',text="/",command=lambda:clickbut("/"),font=("Courier New",16,'bold'))
butdiv.place(x=205,y=310)

butclear=Button(me,padx=14,pady=119,bd=4,bg='light blue',text="CE",command=clrbut,font=("Courier New",16,'bold'))
butclear.place(x=270,y=100)

butequal=Button(me,padx=151,pady=14,bd=4,bg='light blue',command=equalbut,text="=",font=("Courier New",16,'bold'))
